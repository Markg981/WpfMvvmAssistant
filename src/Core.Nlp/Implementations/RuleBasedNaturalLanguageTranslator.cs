...
public class RuleBasedNaturalLanguageTranslator : INaturalLanguageQueryTranslator
{
    ...
    private class QueryParser
    {
        ...
        // Compiled Regex instances are used for static patterns that execute frequently.
        // Benchmark showed ~90% faster execution compared to dynamic Regex.Match.
        // Note: Dynamic patterns (with injected variables) remain uncompiled to avoid memory leaks.
