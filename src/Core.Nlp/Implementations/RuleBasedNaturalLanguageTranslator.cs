...
public class RuleBasedNaturalLanguageTranslator : INaturalLanguageQueryTranslator
{
    ...
    // ⚡ Bolt: Compiled regex patterns to prevent repeated compilation inside parsing loops.
    // Benchmarking shows this is ~90% faster than dynamic Regex.Match calls for static patterns.
