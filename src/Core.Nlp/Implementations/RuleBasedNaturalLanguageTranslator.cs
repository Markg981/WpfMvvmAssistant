...
public class RuleBasedNaturalLanguageTranslator : INaturalLanguageQueryTranslator
{
    ...
    {
        // Performance Optimization: Compiled regexes for static patterns to avoid recompilation overhead
        // Note: Dynamic patterns (injecting columnName) remain uncompiled to prevent memory leaks
