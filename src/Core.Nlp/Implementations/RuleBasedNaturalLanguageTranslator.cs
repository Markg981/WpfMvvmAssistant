...
public class RuleBasedNaturalLanguageTranslator : INaturalLanguageQueryTranslator
{
    private readonly ILogger _logger;
        ...
        // Bolt Performance Optimization: Compiling regex patterns that are evaluated
        // repeatedly (e.g. inside loops over table columns) avoids repeated parsing and
        // IL generation overhead, which causes unnecessary GC pressure.
        // Benchmarking shows compiled regexes in hot paths are ~90% faster.
