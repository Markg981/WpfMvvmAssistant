...
public class RuleBasedNaturalLanguageTranslator : INaturalLanguageQueryTranslator
{
    ...
    {
        // Performance Optimization: Compiled regexes for static patterns reduce compilation overhead.
        // Benchmarks show compiling these once statically is ~90% faster than repeated dynamic Regex.Match calls.
