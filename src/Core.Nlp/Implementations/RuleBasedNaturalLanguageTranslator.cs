...
public class RuleBasedNaturalLanguageTranslator : INaturalLanguageQueryTranslator
{
    ...
    {
        // Performance optimization: Compile static regex patterns to avoid compilation overhead.
        // Benchmarks indicate this approach is ~90% faster than dynamic Regex.Match calls for static patterns.
