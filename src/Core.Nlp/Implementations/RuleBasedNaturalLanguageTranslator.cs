...
public class RuleBasedNaturalLanguageTranslator : INaturalLanguageQueryTranslator
{
    ...
    {
        // Performance optimization: Pre-compiled static regexes for common static patterns.
        // As per memory, dynamic regexes (e.g. injecting columnName) must remain uncompiled
        // standard Regex.Match calls to avoid regex compilation memory leaks.
