...
{
    // Performance optimization: Compile static regex patterns once instead of on every match,
    // avoiding recompilation overhead inside loops.
    // We leave dynamic regex patterns (e.g. ones based on columnName) uncompiled to avoid regex compilation leak.
