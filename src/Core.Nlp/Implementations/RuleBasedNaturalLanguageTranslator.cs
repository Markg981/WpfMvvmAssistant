...
public class RuleBasedNaturalLanguageTranslator : INaturalLanguageQueryTranslator
{
    ...
    {
        // Performance Optimization: Compile static regex patterns once to avoid recompilation overhead inside loops.
        // Note: Dynamic patterns (with variables) must remain uncompiled (Regex.Match) to prevent memory leaks.
