...
public class RuleBasedNaturalLanguageTranslator : INaturalLanguageQueryTranslator
{
    ...
    private class QueryParser
    {
        ...
        // Compiling these frequently used regexes reduces the processing time of NLP query parsing
        // by avoiding repeated compilation within nested table/column loops.
