...
public class RuleBasedNaturalLanguageTranslator : INaturalLanguageQueryTranslator
{
    ...
    private class QueryParser
    {
        ...
        // Static regex patterns are compiled once to avoid ~90% of the overhead on repeated calls.
        // Dynamic patterns (e.g. injecting variable column names) are left uncompiled to avoid memory leaks.
