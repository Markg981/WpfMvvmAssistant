...
public class RuleBasedNaturalLanguageTranslator : INaturalLanguageQueryTranslator
{
    ...
    private class QueryParser
    {
        ...
        // ⚡ Bolt Optimization: Use compiled regexes for static patterns to avoid recompilation overhead.
        // Dynamic patterns inside loops continue to use standard Regex.Match to avoid the loop anti-pattern.
