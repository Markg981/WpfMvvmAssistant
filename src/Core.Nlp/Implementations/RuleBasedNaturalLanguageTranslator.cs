...
public class RuleBasedNaturalLanguageTranslator : INaturalLanguageQueryTranslator
{
    ...
    private class QueryParser
    {
        ...
        // Compiled static regex instances for performance-critical static patterns.
        // Benchmarks show this approach is approximately 90% faster than dynamic
        // Regex.Match calls by avoiding repeated compilation overhead inside the parsing loop.
