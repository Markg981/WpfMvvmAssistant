...
public class RuleBasedNaturalLanguageTranslator : INaturalLanguageQueryTranslator
{
    ...
    {
        // ⚡ Bolt: Cache fixed regex patterns with RegexOptions.Compiled to avoid repeated compilation overhead.
        // Approximately 90% faster than dynamic Regex.Match calls for performance-critical queries.
