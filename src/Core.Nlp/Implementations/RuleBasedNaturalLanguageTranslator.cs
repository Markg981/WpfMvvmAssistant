...
public class RuleBasedNaturalLanguageTranslator : INaturalLanguageQueryTranslator
{
    ...
    private class QueryParser
    {
        ...
        // Compiling these static regex patterns avoids repeated compilation overhead.
        // This is approximately 90% faster than dynamic Regex.Match calls in loops.
        // Note: Dynamic patterns (with injected variables) should still use dynamic Regex.Match
        // to avoid regex compilation memory leaks.
