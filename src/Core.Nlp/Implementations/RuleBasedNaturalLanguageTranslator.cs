...
public class RuleBasedNaturalLanguageTranslator : INaturalLanguageQueryTranslator
{
    ...
    {
        // Performance Optimization: Compiled regex instances for static patterns to avoid recompilation overhead.
        // Benchmark shows ~90% faster execution. Dynamic regexes in the loop remain standard Regex.Match to avoid GC pressure.
