...
public class RuleBasedNaturalLanguageTranslator : INaturalLanguageQueryTranslator
{
    ...
    {
        // ⚡ Bolt: Cache static compiled regex patterns to avoid repeated compilation overhead.
        // Dynamic patterns (e.g., column names) remain as standard Regex.Match to avoid compilation memory leaks.
