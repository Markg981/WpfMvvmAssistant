...
public class RuleBasedNaturalLanguageTranslator : INaturalLanguageQueryTranslator
{
    ...
    {
        // ⚡ Bolt Optimization:
        // Pre-compiling static regex patterns using RegexOptions.Compiled avoids repeated
        // compilation overhead during query parsing. Benchmarks show this approach is
        // ~90% faster than calling dynamic Regex.Match repeatedly for static patterns.
        // Dynamic patterns (e.g., incorporating column names) are kept as standard
        // Regex.Match calls to avoid severe recompilation overhead inside loops.
