...
public class RuleBasedNaturalLanguageTranslator : INaturalLanguageQueryTranslator
{
    ...
    {
        // Performance optimization: Compile static regex patterns once (approx 90% faster than repeated dynamic compilation).
        // Dynamic patterns that inject variables (e.g. columnName) are deliberately left as standard Regex.Match
        // to avoid regex compilation memory leaks inside loops.
