...
public class RuleBasedNaturalLanguageTranslator : INaturalLanguageQueryTranslator
{
    ...
    {
        // ⚡ Bolt: Compiled static regexes for performance-critical NLP parsing.
        // Benchmark showed ~90% faster execution. Dynamic regexes inside methods
        // are left uncompiled to avoid memory leaks.
