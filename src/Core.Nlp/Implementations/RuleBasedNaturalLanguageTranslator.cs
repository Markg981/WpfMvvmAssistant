...
public class RuleBasedNaturalLanguageTranslator : INaturalLanguageQueryTranslator
{
    ...
    {
        // ⚡ Bolt: Static regex patterns are compiled once to avoid overhead in parsing loops.
        // Dynamic regexes (like those dependent on column names) are NOT compiled,
        // because recompiling dynamic strings inside a loop is a major performance anti-pattern.
