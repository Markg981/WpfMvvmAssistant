...
public class RuleBasedNaturalLanguageTranslator : INaturalLanguageQueryTranslator
{
    ...
    {
        // Performance optimization: Compile static regex patterns once to avoid
        // recompilation overhead in tight loops during natural language parsing.
        // Benchmark: ~90% faster than dynamic Regex.Match calls.
