...
public class RuleBasedNaturalLanguageTranslator : INaturalLanguageQueryTranslator
{
    ...
    {
        // Performance optimization: Compile static regex patterns for performance.
        // As per benchmarking, compiled static patterns are ~90% faster.
        // Dynamic patterns (relying on interpolated strings like columnName) are excluded to avoid severe recompilation overhead.
