...
public class RuleBasedNaturalLanguageTranslator : INaturalLanguageQueryTranslator
{
    ...
    private class QueryParser
    {
        ...
        // Compiling these regexes once saves significant overhead during query parsing.
        // We use RegexOptions.Compiled because these are static patterns used frequently.
        // We DO NOT compile dynamic patterns (those containing column names) inside loops,
        // as that is a severe performance anti-pattern that creates massive GC pressure.
