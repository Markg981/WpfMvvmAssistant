...
public class RuleBasedNaturalLanguageTranslator : INaturalLanguageQueryTranslator
{
    ...
    {
        // ⚡ Bolt: Cache static regex patterns with Compiled flag to avoid repeated parsing overhead in tight loops.
        // Note: Dynamic patterns (containing variables) must remain standard Regex.Match calls to avoid memory leaks.
